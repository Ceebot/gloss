    ...
    <div class="container hero__container">
        <div class="hero__content">
            ...
            <div class="hero__action">
                <a href="#section-form" class="btn btn-big hero__btn">Записаться</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <ul class="do__list-services">
            ...
            while ($service = $items->fetch_assoc()) {
                ...
                <li class="do__item-services" style="background-image: url('img/services/<?= $service['img']; ?>')">
                    <div class="do__item-services-content">
                        <strong class="do__item-services-heading">
                            <?= $service['title']; ?></strong>
                        <p class="do__item-services-description">
                            <?= $service['description'], " ", $service['price']; ?> &#8381</p>
                    </div>
                </li>
                <?
            } ?>
        ...
        <div class="do__promotional">
            <div class="do__promitional-text">
                <p class="do__promitional-desc">Профессиональная</p>
...
<section class="contacts" id="section-contacts">
    <div class="container">
        ...
        <div class="contacts__container">
            ...
            <div class="contacts__map-480px" style="position:relative;overflow:hidden;">
                <div style="position:relative;overflow:hidden;"><a
                            href="https://yandex.ru/maps/org/glyanets/124969761230/?utm_medium=mapframe&utm_source=maps"
                            style="color:#eee;font-size:12px;position:absolute;top:0px;">Глянец</a>
                    <a href="https://yandex.ru/maps/11239/gornyak/category/hairdressers/184105812/?utm_medium=mapframe&utm_source=maps"
                       style="color:#eee;font-size:12px;position:absolute;top:14px;">Парикмахерская в Горняке</a>
                    <iframe class="contacts__iframe" src="https://yandex.ru/map-widget/v1/-/CCURQEVs-B" width="100%"
                            height="300" frameborder="1" allowfullscreen="true" style="position:relative;">
                    </iframe>
                </div>
            </div>
        </div>
